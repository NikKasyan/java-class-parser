...
import { ModuleAttribute } from "./attributes/module";
...
type ConstantWithRaw = Constant & { raw: RawConstantPoolInfo };
type FieldInfoWithRaw = FieldInfo & { raw: RawFieldInfos };
type MethodInfoWithRaw = MethodInfo & { raw: RawMethodInfo };
type AttributeInfoWithRaw = AttributeInfo & { raw: RawAttributeInfo };
